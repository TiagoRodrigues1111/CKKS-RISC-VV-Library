...
*/
int CWM_test_01(int (*CWM_function)(struct ciphertext, struct ciphertext,struct ciphertext*),struct params params1)
{
        ...
        // Perform operation
        (*CWM_function)(ciphertext1,ciphertext2,&ciphertext_result);
...
/*      
        Prints information for an CWM function passed 
*/
int CWM_test_02(int (*CWM_function)(struct ciphertext, struct ciphertext,struct ciphertext*),void (*print_timing_function)(struct timing_variable), struct params params1)
{
        //int (*CWM_function[])(struct ciphertext, struct ciphertext,struct *ciphertext) = {CWM, CWM_auto_vect, CWM_naive_vect};
...
/*      
        Compares two CWM functions
*/
int CWM_test_03(int (*CWM_function_1)(struct ciphertext, struct ciphertext,struct ciphertext*),int (*CWM_function_2)(struct ciphertext, struct ciphertext,struct ciphertext*), struct params params1)
{
        ...
        (*CWM_function_1)(ciphertext1,ciphertext2,&ciphertext_result1);
        
        // Perform operation
        (*CWM_function_2)(ciphertext1,ciphertext2,&ciphertext_result2);
...
{ 
        ...
        #if RISCV_VECTORIAL
                int (*CWM_function[])(struct ciphertext, struct ciphertext,struct ciphertext*) = {CWM_true,CWM_true_barrett, CWM_true_vectorial,CWM_true_vectorial_barrett};
        #else
                int (*CWM_function[])(struct ciphertext, struct ciphertext,struct ciphertext*) = {CWM_true,CWM_true_barrett};
        #endif
        ...
        {
                case 0:
                        CWM_test_01((*CWM_function[options1.function_to_test[0]]),params1);           
                        break;
                case 1:
                        CWM_test_02((*CWM_function[options1.function_to_test[0]]),print_timing,params1);           
                        break; 
                case 2:
                        CWM_test_03((*CWM_function[options1.function_to_test[0]]),(*CWM_function[options1.function_to_test[1]]),params1);
                        break;  
