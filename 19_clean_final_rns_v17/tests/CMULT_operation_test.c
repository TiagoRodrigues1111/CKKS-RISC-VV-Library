...
*/
int CMULT_test_01(int (*CMULT_function)(struct ciphertext, struct plaintext,struct ciphertext*),struct params params1)
{
        ...
        initiate_to_constant_plaintext(&plaintext, 23456);  
        initiate_to_constant_ciphertext(&ciphertext_result, 0);
               
        // Perform operation
        (*CMULT_function)(ciphertext,plaintext,&ciphertext_result);
...
*/
int CMULT_test_02(int (*CMULT_function)(struct ciphertext, struct plaintext,struct ciphertext*),void (*print_timing_function)(struct timing_variable), struct params params1)
{
...
*/
int CMULT_test_03(int (*CMULT_function_1)(struct ciphertext, struct plaintext,struct ciphertext*),int (*CMULT_function_2)(struct ciphertext, struct plaintext,struct ciphertext*), struct params params1)
{
        ...
        (*CMULT_function_1)(ciphertext,plaintext,&ciphertext_result1);
        
        // Perform operation
        (*CMULT_function_2)(ciphertext,plaintext,&ciphertext_result2);
...
{ 
        #if RISCV_VECTORIAL
                int (*CMULT_function[])(struct ciphertext, struct plaintext,struct ciphertext*) = {CMULT_naive, CMULT_naive_auto_vect, CMULT_naive_vect,CMULT_barrett, CMULT_barrett_auto_vect, CMULT_barrett_vect};
 
        #else
                int (*CMULT_function[])(struct ciphertext, struct plaintext,struct ciphertext*) = {CMULT_naive, CMULT_naive_auto_vect,CMULT_barrett, CMULT_barrett_auto_vect};
        ...
        {
                case 0:
                        CMULT_test_01((*CMULT_function[options1.function_to_test[0]]),params1);           
                        break;
                case 1:
                        CMULT_test_02((*CMULT_function[options1.function_to_test[0]]),print_timing,params1);           
                        break; 
                case 2:
                        CMULT_test_03((*CMULT_function[options1.function_to_test[0]]),(*CMULT_function[options1.function_to_test[1]]),params1);
                        break;                                
                case 3:
