...
*/
int CADD_test_01(int (*CADD_function)(struct ciphertext, struct plaintext,struct ciphertext*),struct params params1)
{
        ...
        // Perform operation
        (*CADD_function)(ciphertext,plaintext,&ciphertext_result);
...
*/
int CADD_test_02(int (*CADD_function)(struct ciphertext, struct plaintext,struct ciphertext*),void (*print_timing_function)(struct timing_variable), struct params params1)
{
...
*/
int CADD_test_03(int (*CADD_function_1)(struct ciphertext, struct plaintext,struct ciphertext*),int (*CADD_function_2)(struct ciphertext, struct plaintext,struct ciphertext*), struct params params1)
{
        ...
        (*CADD_function_1)(ciphertext,plaintext,&ciphertext_result1);
        
        // Perform operation
        (*CADD_function_2)(ciphertext,plaintext,&ciphertext_result2);
...
/*      
        Compares two HADD functions
*/
int CADD_test_04(int (*CADD_function_1)(struct ciphertext, struct plaintext,struct ciphertext*),int (*CADD_function_2)(struct ciphertext, struct plaintext,struct ciphertext*), struct params params1)
{
        ...
        // Initiate ciphertexts with some values
        initiate_to_constant_ciphertext(&ciphertext, 10000);
        initiate_to_random_plaintext(&plaintext, 234567);  
        initiate_to_constant_ciphertext(&ciphertext_result1, 0);
        initiate_to_constant_ciphertext(&ciphertext_result2, 0);
...
{ 
        #if RISCV_VECTORIAL
                int (*CADD_function[])(struct ciphertext, struct plaintext,struct ciphertext*) = {CADD_naive, CADD_naive_auto_vect, CADD_naive_vect, CADD_barrett, CADD_barrett_auto_vect, CADD_barrett_vect};
        #else
                int (*CADD_function[])(struct ciphertext, struct plaintext,struct ciphertext*) = {CADD_naive, CADD_naive_auto_vect,CADD_barrett, CADD_barrett_auto_vect};
        #endif
        int opt;     
        ...
        {
                case 0:
                        CADD_test_01((*CADD_function[options1.function_to_test[0]]),params1);           
                        break;
                case 1:
                        CADD_test_02((*CADD_function[options1.function_to_test[0]]),print_timing,params1);           
                        break; 
                case 2:
                        CADD_test_03((*CADD_function[options1.function_to_test[0]]),(*CADD_function[options1.function_to_test[1]]),params1);
                        break;            
                case 3:
                        // run a specific function passed in the -f param
                        break;
                case 4:
                        CADD_test_04((*CADD_function[options1.function_to_test[0]]),(*CADD_function[options1.function_to_test[1]]),params1);
                        break;           
