        ...
        {  
                ...
                for(j=0;j<stop_value;j++)
                {
                        ...
                        for(k=0;k<stop_value;k++)
                        {
                                ...
                                // Relin1 * CT3
                                auxiliary_array[0][j+k]	+= relinearization_keys.values[0][j] * Ciphertext.values[2][i][j];
			
                                // Relin2 * CT3
                                auxiliary_array[1][j+k]	+= relinearization_keys.values[1][j] * Ciphertext.values[2][i][j];
                        }		
                }
