...
*/
#ifndef HSUB_NO_OVERFLOW_H
#define HSUB_NO_OVERFLOW_H
...
* \return Return an error code, where 0 is success and anything else is failure
*/
int HSUB_naive_inline_nof(struct ciphertext Ciphertext1,struct ciphertext Ciphertext2, struct ciphertext *Ciphertext_result);
